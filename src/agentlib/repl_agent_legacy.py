"""
REPLAgentLegacy: Agent paradigm where LLM writes Python code instead of tool calls.
...
-----------
    ...
    from agentlib import REPLAgentLegacy

    class MyAgent(REPLAgentLegacy):
        system = "You are a helpful assistant."

        @REPLAgentLegacy.tool
...
# ---------------------------------------------------------------------------
# REPLAgentLegacy: First-class agent type
# ---------------------------------------------------------------------------

class REPLAgentLegacy(REPLMixin, BaseAgent):
    """
